...
router.get("/", async (req, res) => {
  try {
    ...
    const url = `https://trendlyne.com/fundamentals/all-in-one-screener-data-get/?perPageCount=25&pageNumber=${
      offset - 1
    }&columns=day_changeP%2CcurrentPrice%2CMCAP_Q%2Cday_change%2Cvol_day%2Cweek_changeP%2Cmonth_changeP%2Cqtr_changeP%2Cyear_changeP%2Cyear_low&groupType=all&groupName=&sortBy=day_changeP&order=ASC&query=day_changeP+%3C+0&filterListId=&format=json`;
